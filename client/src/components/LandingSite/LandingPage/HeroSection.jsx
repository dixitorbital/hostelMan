...
function HeroSection() {
  return (
    //bg-[#081a3f]
    <main className="flex flex-col bg-gray-800  justify-center align-center bg-cover bg-center bg-no-repeat h-screen  text-white text-center">
      ...
      <div className="">
        <h1 className="font-bold text-7xl">
          Campus<span className="text-green-500"> Hostel Management</span>{" "}
          System
        </h1>
        <p className="py-10 text-2xl  font-bold">
          One Solution For All Of The{" "}
          <span className="text-green-500"> Hostel&apos;s</span> Needs
        </p>
        <div className="py-5">
          {/* <Link
            to="/auth/login"
            className="bg-blue-600 py-3 px-40 hover:bg-blue-700 transition rounded text-2xl"
          >
            Login
          </Link> */}
