...
function Contact() {
  ...
  return (
    <section className="bg-white overflow-hidden w-[800px] mx-auto">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen">
        <h2 className=" mb-2 text-4xl tracking-tight font-bold text-center text-gray-700 dark:text-white">
          Contact Us
        </h2>
        <p className="mb-1 lg:mb-16  text-center text-gray-600 dark:text-gray-400 sm:text-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <button
            type="submit"
            className="py-3 px-5 text-sm font-medium bg-neutral-500 text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
